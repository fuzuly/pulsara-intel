...
export const NEW_PRODUCTS = [
  ...
  },
  {
    ...
    layer: 2,
    osintConfidence: 72,
    tags: ['yaz', 'limonata', 'soğuk', 'gençlik', 'yakında'],
  ...
  // ════════════════════════════════════════════════════════════════════════
  // KAHVE DÜNYASI — Ramazan 2026 Koleksiyonu (Şubat 2026)
  // Kaynak: mallreport.com.tr (27 Şubat 2026) — Katman 2
  // ════════════════════════════════════════════════════════════════════════

  {
    id: 'kd-2026-001',
    brand: 'kahvedunyasi',
    name: 'Tahinli Milkshake',
    category: 'Sezonluk',
    launchDate: '2026-02-27',
    detectedAt: '2026-02-27',
    price: null,
    description: 'Kahve Dünyası\'nın kendi üretimiyle hazırlanan tahin bazlı milkshake. Ramazan 2026 koleksiyonu kapsamında sunuldu.',
    status: 'active',
    isOwn: false,
    layer: 2,
    osintConfidence: 82,
    tags: ['ramazan', 'milkshake', 'tahin', 'sezonluk'],
    source: 'mallreport.com.tr — Ramazana Özel Lezzetlerle Kahve Dünyası (27 Şubat 2026)',
  },
  {
    id: 'kd-2026-002',
    brand: 'kahvedunyasi',
    name: 'Tahinli Badem Sütlü Caffe Latte',
    category: 'Sezonluk',
    launchDate: '2026-02-27',
    detectedAt: '2026-02-27',
    price: null,
    description: 'Tahin ve badem sütü kombinasyonlu latte varyasyonu. Ramazan 2026 koleksiyonu kapsamında sunuldu. Bitkisel süt trendine uygun formülasyon.',
    status: 'active',
    isOwn: false,
    layer: 2,
    osintConfidence: 82,
    tags: ['ramazan', 'latte', 'tahin', 'badem-sütü', 'sezonluk'],
    source: 'mallreport.com.tr — Ramazana Özel Lezzetlerle Kahve Dünyası (27 Şubat 2026)',
  },
  {
    id: 'kd-2026-003',
    brand: 'kahvedunyasi',
    name: 'Hurma Dolgulu Kurabiye',
    category: 'Yiyecek',
    launchDate: '2026-02-27',
    detectedAt: '2026-02-27',
    price: null,
    description: 'Hurma dolgulu özel kurabiye. Kahve Dünyası Ramazan 2026 koleksiyonunun parçası.',
    status: 'active',
    isOwn: false,
    layer: 2,
    osintConfidence: 82,
    tags: ['ramazan', 'kurabiye', 'hurma', 'sezonluk'],
    source: 'mallreport.com.tr — Ramazana Özel Lezzetlerle Kahve Dünyası (27 Şubat 2026)',
  },
  {
    id: 'kd-2026-004',
    brand: 'kahvedunyasi',
    name: 'Çikolata Kaplı Hurma — Altınmarka Kolaborasyonu',
    category: 'Yiyecek',
    launchDate: '2026-02-27',
    detectedAt: '2026-02-27',
    price: null,
    description: 'Altınmarka çikolatasıyla kaplı hurma. Kahve Dünyası × Altınmarka kolaborasyonu. Ramazan 2026 koleksiyonunun özel ürünü.',
    status: 'active',
    isOwn: false,
    layer: 2,
    osintConfidence: 82,
    tags: ['ramazan', 'hurma', 'kolaborasyon', 'çikolata', 'sezonluk'],
    source: 'mallreport.com.tr — Ramazana Özel Lezzetlerle Kahve Dünyası (27 Şubat 2026)',
  },
