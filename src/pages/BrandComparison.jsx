...
export default function BrandComparison() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Tab navigasyon */}
      <div className="flex gap-1 border-b border-navy-border overflow-x-auto no-scrollbar">
        {TABS.map(tab => {
          const Icon = tab.icon;
          return (
            <button
      ...
      {activeTab === 'operations' && (
        <div className="space-y-4">
          {/* Özet kartlar */}
          <div className="overflow-x-auto -mx-1">
          <div className="grid gap-3" style={{ gridTemplateColumns: `repeat(${selectedIds.length}, minmax(160px, 1fr))` }}>
            {opBrands.map(b => (
